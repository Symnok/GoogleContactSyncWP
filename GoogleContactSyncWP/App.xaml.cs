...
using GoogleContactSyncWP.Resources;
...
namespace GoogleContactSyncWP
{
    public partial class App : Application
    {
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            string msg = "CRASH: " + e.ExceptionObject.GetType().Name + "\n" +
                         e.ExceptionObject.Message + "\n\n" +
                         e.ExceptionObject.StackTrace;

            // Save to IsolatedStorage settings
            System.IO.IsolatedStorage.IsolatedStorageSettings.ApplicationSettings["LastCrash"] = msg;
